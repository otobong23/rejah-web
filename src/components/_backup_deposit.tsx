...
const page = () => {
   ...
   const [address, setAddress] = useState('48394u83uc483jjds884334') //dummy address
   const [stack, setStack] = useState(1);
   const [miniStack, setMiniStack] = useState(1)
         ...
         <div className='max-w-[396px] mx-auto'>
            ...
            {stack === 2 && (
               <>
                  ...
                  <div>
                     <div className='p-4 bg-white rounded-[15px] w-fit mx-auto mb-[30px]'><QRCodeGenerator address={address} /></div>
                        ...
                        <div>
                           <div className='text-[#A8A79E] text-xs mb-14'>
                              ...
                              <div className='flex justify-between'>
                                 ...
                                 <button className='cursor-pointer' onClick={() => handleCopy(amount)}>
